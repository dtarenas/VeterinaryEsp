...
namespace Veterinary.API.Data.SeedDb
{
    public class SeedDb
    {
        ...
        public SeedDb(VeterinaryDbContext context, IUserHelper userHelper)
        {
            _context = context;
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync(
                ...
                firstName: "Diego A.", 
                lastName: "Arenas T.", 
                email: "diegoarenas97258@correo.itm.edu.co", 
                phone: "1026145155", 
                address: "Cra 123 456 78", 
